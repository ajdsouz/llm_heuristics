...
if __name__=="__main__":
    ...
    with open(f"{args.experiment_dir}/best_heuristics.json") as jf:
        bh = json.load(jf)
    ...
    exp_script = f"exps/{exp_data['model_name']}-{exp_data['domain']}-{args.split}-{args.subset}-{args.version}.py"
