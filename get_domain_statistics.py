...
def find_instances(domain, instance_directory) -> tuple[str, str, float]:
    """
    ...
    average = sum([v for _, v in results]) / len(results)
    ...
    return smallest[1], largest[1], average
...
if __name__=="__main__":
    ...
    smallest, largest, average = find_instances(domain_file, args.instance_dir)
